...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
     // We create a popup for each circleMarker to display  magnitude & location of the earthquake
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  tectonicPlatesLink = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
